...
$list_tolgate_query="SELECT * FROM `tolgate_list`";
							...
							<div id="container">
								...
								<center>
									...
									<table border="1">
										...
										<td>
										<?php
										echo $list_tolgate_row['sources'];
										?>	
										</td>
										<td>
										<?php
										echo $list_tolgate_row['destination'];
										?>		
										</td>
										<td>
										<a href="add-tolgate_detail.php?id=<?php echo $list_tolgate_row['id']; ?>&limit=<?php echo $list_tolgate_row['no_of_tolgate']; ?>">
										<?php
										echo $list_tolgate_row['no_of_tolgate'];
										?>	
										</a>
										</td>
										<td>
											<a href="edit.php?id=<?php echo $list_tolgate_row['id']; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>&nbsp;&nbsp;&nbsp;<a href="?delete_id=<?php echo $list_tolgate_row['id']; ?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
										</td>	
										</tr>
										<?php
										$i++;
...
$delete_query="DELETE FROM `tolgate_list` WHERE `id`='$delete_id'";
