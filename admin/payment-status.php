						...
						<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
						   <div>
							<div id="container">
								<center>
									<?php 
									$tolgate_list_query="SELECT * FROM `travel_distances` GROUP BY `payment_id`";
									...
									<tr>
										...
										<td>
											<a href="view-tolgate-page.php?id=<?php echo $tolgate_list_row['payment_id']; ?>"><?php echo $tolgate_list_row['payment_id']; ?></a>
