							...
							<div id="container">
								...
								<center>
									...
									<table>
										...
										<td>
											<input type="text" name="source_place" placeholder="Source Place" required="">
										</td>
										</tr>
										<tr>
										<th>
										...
										<td>
											<input type="text" name="destination_place" placeholder="Destination Place" required="">
										</td>
										</tr>
										<tr>
										<th>
										...
										<td>
											<input type="text" name="no-of-tolgate" placeholder="No of Tolgate" required="">
										</td>
										</tr>
										<tr>
...
$insert_query="INSERT INTO `tolgate_list`(`sources`, `destination`, `no_of_tolgate`) VALUES ('$source_place','$destination_place','$no_of_tolgate')";
$insert_query_res=mysqli_query($con,$insert_query);
if($insert_query_res){
echo "<script>alert('Added Sucessfully');</script>";
echo "<script>window.location='add-tolgate-place.php';</script>";
}else{
