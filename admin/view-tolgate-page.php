...
$serach_query="SELECT * FROM `travel_history` WHERE `id`='$payment_id'";
...
<?php
	...
	<div class="total-ads main-grid-border">
		<div class="container">
			...
			<div class="ads-grid">
				<div class="side-bar col-md-3" style="    border-left: 2px solid #FFFFFF;
						...
						<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
						   <div>
							<div id="container">
								...
								<center>
									<br>
									<h1>Travelled History</h1>
									<br>
									<?php 
									$tolgate_list_query="SELECT * FROM `travel_distances` WHERE `payment_id`='$payment_id'";
									$tolgate_list_res=mysqli_query($con,$tolgate_list_query);
									?>
									<table>
									<?php
									while ($tolgate_list_row=mysqli_fetch_assoc($tolgate_list_res)) {
									?>
									...
									<tr>
										...
										<td>
											<?php echo $tolgate_list_row['tolgate_name']; ?>
